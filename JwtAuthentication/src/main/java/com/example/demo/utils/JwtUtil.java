...
public class JwtUtil {
	...
	// claims are pieces of information or assertions about a subject (typically the
	// user) that are encoded into the token. Claims provide information such as the
	// identity of the user, the token's expiration time, and any additional
	// metadata relevant to the application's authentication and authorization
	// processes.
